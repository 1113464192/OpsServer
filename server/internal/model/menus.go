...
type Menus struct {
	...
	Title      string      `json:"title" gorm:"type:varchar(50);index;comment:菜单名;type:varchar(30)"` // 菜单名
	...
	UserGroups []UserGroup `json:"group,omitempty" gorm:"many2many:permit_menus;"`
}
