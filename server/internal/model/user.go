...
type User struct {
	...
	Username   string      `json:"username" gorm:"type:varchar(30);unique;index"`
	...
	Mobile     string      `json:"mobile" gorm:"type:varchar(15);unique"`
	LoginTime  int64       `json:"login_time"`
	Expiration uint64      `json:"expiration"`
	IsAdmin    uint8       `json:"is_admin" gorm:"default:0"`
	PriKey     []byte      `json:"pri_key" gorm:"type:blob;comment: 用户私钥，不传为NULL;unique"`
