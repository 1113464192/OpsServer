...
type UpdateHostReq struct {
	...
	Name       string  `form:"name" json:"name" binding:"required"` // fqh-1
	...
	Cloud      string  `form:"cloud" json:"cloud" binding:"required"`             // 如：腾讯云
	System     string  `form:"system" json:"system" binding:"required"`           // 如：Centos7
	Mbps       uint32  `form:"mbps" json:"mbps" binding:"required"`               // 如：带宽
